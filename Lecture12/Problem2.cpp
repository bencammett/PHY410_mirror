...
public : 
  ...
  {    
    ...
    for (int i = 0; i < _steps; i++) {
      ...
      d_theta = - _b * adaptive_trapezoid(_dThetaDr, r_lower, r_upper, accuracy);
      r_theta.first -= dr;
...
$ python -i read_plot.py
>>> import matplotlib.pyplot as plt
>>> [x4,y4] = read_plot("trajfile_cpp_4.data")
>>> plt.plot(x4,y4)
[<matplotlib.lines.Line2D object at 0x2d92950>]
>>> plt.show()
